...
namespace bsn.ModuleStore.Mapper {
	public class DistinctInstanceProvider<TKey>: DistinctInstanceProviderBase<TypeKey<TKey>, TKey> where TKey: IEquatable<TKey> {
	...
	public class DistinctInstanceProvider: DistinctInstanceProviderBase<TypeKey, object> {
