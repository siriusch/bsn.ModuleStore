...
namespace bsn.ModuleStore.Sql.Script {
	public class SelectFromQuery: SelectQuery {
		...
		public SelectFromQuery(TopExpression top, DuplicateRestriction restriction, Sequence<ColumnItem> columnItems, Optional<DestinationRowset> intoClause, FromClause fromClause, Optional<Predicate> whereClause, Optional<Sequence<Expression>> groupByClause, Optional<Predicate> havingClause,
