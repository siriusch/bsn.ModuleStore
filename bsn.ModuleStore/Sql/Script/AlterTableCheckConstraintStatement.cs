...
namespace bsn.ModuleStore.Sql.Script {
	public class AlterTableCheckConstraintStatement: AlterTableCheckConstraintStatementBase {
		[Rule("<AlterTableStatement> ::= ALTER TABLE <TableNameQualified> <TableCheck> CHECK CONSTRAINT <ConstraintName>", ConstructorParameterMapping = new[] {2, 3, 6})]
		...
		[Rule("<AlterTableStatement> ::= ALTER TABLE <TableNameQualified> <TableCheck> CHECK CONSTRAINT ALL", ConstructorParameterMapping = new[] {2, 3})]
