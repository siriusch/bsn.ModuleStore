...
namespace bsn.ModuleStore.Sql.Script {
	public class Optional<T>: SqlToken where T: SqlToken {
		...
		[Rule("<OptionalFunctionParameterList> ::=", typeof(Sequence<Parameter>))]
		[Rule("<OptionalVarying> ::=", typeof(VaryingToken))]
		[Rule("<OptionalOutput> ::=", typeof(UnreservedKeyword))]
		[Rule("<OptionalReadonly> ::=", typeof(UnreservedKeyword))]
		...
		[Rule("<OptionalFunctionParameterList> ::= <FunctionParameterList>", typeof(Sequence<Parameter>))]
		[Rule("<OptionalVarying> ::= VARYING", typeof(VaryingToken))]
		[Rule("<OptionalOutput> ::= OUTPUT", typeof(UnreservedKeyword))]
		[Rule("<OptionalReadonly> ::= READONLY", typeof(UnreservedKeyword))]
