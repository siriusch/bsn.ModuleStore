...
namespace bsn.ModuleStore.Sql.Script {
	public sealed class TableUniqueConstraint: TableUniqueConstraintBase {
		[Rule("<TableConstraint> ::= ~UNIQUE <ConstraintCluster> ~'(' <IndexColumnList> ~')' <IndexOptionGroup>")]
		public TableUniqueConstraint(ConstraintClusterToken clustered, Sequence<IndexColumn> indexColumns, IndexOptionGroup indexOptionGroup): this(null, clustered, indexColumns, indexOptionGroup) {}
