...
namespace bsn.ModuleStore.Sql.Script {
	public sealed class AlterTableColumnNotForReplicationStatement: AlterTableColumnAttributeStatement {
		[Rule("<AlterTableStatement> ::= ALTER TABLE <TableNameQualified> ALTER COLUMN <ColumnName> ADD NOT FOR_REPLICATION", ConstructorParameterMapping = new[] {2, 5, 6})]
		[Rule("<AlterTableStatement> ::= ALTER TABLE <TableNameQualified> ALTER COLUMN <ColumnName> DROP NOT FOR_REPLICATION", ConstructorParameterMapping = new[] {2, 5, 6})]
